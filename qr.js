              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hello there KERM MD User! 👋🏻* 

> Do not share your session id with anyone.

 *Thanks for using KERM-MD-V1 🚩* 
...
contextInfo: {
externalAdReply: {
title: "𝐤𝐞𝐫𝐦 𝐦𝐝 𝐛𝐨𝐭 𝐜𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝",
thumbnailUrl: "https://files.catbox.moe/yw2ty2.jpeg",
